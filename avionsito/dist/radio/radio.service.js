...
let RadioService = class RadioService {
    constructor(_radioRepository) {
        this._radioRepository = _radioRepository;
    ...
    buscarTodos() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._radioRepository.find();
        });
    }
    crear(max, min) {
        return __awaiter(this, void 0, void 0, function* () {
...
RadioService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(radio_entity_1.RadioEntity)),
